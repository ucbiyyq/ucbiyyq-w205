...
DROP TABLE hospital_compare.discover_complications_state;

CREATE TABLE hospital_compare.discover_complications_state AS
SELECT
    state,
    measure_id,
    measure_name,
...
FROM hospital_compare.land_complications_state;
